...
export default function Services(){return <>
  ...
  <section className="services-programs-v3" id="programs"><div className="services-wrap"><Reveal><div className="services-section-head"><div><h2>Choose Your Pathway</h2><p className="services-pathway-subheading">Support designed for your next academic step.</p></div><p></p></div></Reveal><ServiceExplorer/></div></section>
